...
%In particle Swarm Optimization the inertial weight which decides the
%weightage of previous velocity value was introduced later in the improved
%version of PSO. 
%The inertial weightage value is taken to be linearly decreasing and in
%some cases may even provide better and faster optimizing results 
...
% PSO_inertial can also be checked for different benchmark functions - Ackley, Rastrigin
